      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
        ...
        <View style={s.rowItem}>
          <View style={{ flex: 1, paddingRight: 12 }}>
            ...
            <Text style={s.rowSub}>
              Off, the chat is gone when you close the app. On, it is waiting next time.
            </Text>
          </View>
          <Switch value={keep} onValueChange={setKeep} />
        </View>
        <Text style={s.help}>
          Anything sent while they are away reaches them when they open the app.
        </Text>

        <Text style={s.rowTitle}>Messages disappear after</Text>
        <Text style={s.rowSub}>
          Messages you send vanish from both phones after this long.
        </Text>
        <View style={s.chips}>
          {TTL_CHOICES.map((c) => (
            <TouchableOpacity
        ...
        <View style={s.rowItem}>
          <View style={{ flex: 1, paddingRight: 12 }}>
            ...
            <Text style={s.rowSub}>
              Their ticks turn green when you have seen it.
            </Text>
          </View>
        ...
        <Text style={s.rowSub}>
          Untouched for this long, the chat closes itself and asks for the PIN again.
        </Text>
        <View style={s.chips}>
          {IDLE_CHOICES.map((c) => (
            <TouchableOpacity
        ...
        <View style={s.rowItem}>
          <View style={{ flex: 1, paddingRight: 12 }}>
            ...
            <Text style={s.rowSub}>
              Leaving the app closes the chat. A call in progress is the exception.
            </Text>
          </View>
        ...
        <View style={s.rowItem}>
          <View style={{ flex: 1, paddingRight: 12 }}>
            ...
            <Text style={s.rowSub}>
              A small dot and nothing else — no name, no preview, no sound. Works while locked.
            </Text>
          </View>
        ...
        <View style={s.rowItem}>
          <View style={{ flex: 1, paddingRight: 12 }}>
            ...
            <Text style={s.rowSub}>
              On, screenshots and screen recording are refused.
              {Platform.OS === 'ios' ? ' On iPhone, recording only.' : ''}
            </Text>
          </View>
        ...
        <Text style={s.help}>
          What you type into a new note to get in. Changing it disturbs nothing else.
        </Text>
        ...
        <Text style={s.help}>
          Both phones must show the same code.
        </Text>
        ...
        <Text style={s.help}>
          Where the two phones find each other. It sees a hash and ciphertext, and keeps nothing.
        </Text>
        <TextInput
          style={s.input}
          value={relayUrl}
        ...
        <Text style={s.help}>
          How calls find a route. Leave it alone unless calls stop connecting.
        </Text>
        <TextInput
